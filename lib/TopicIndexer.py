...
class TopicIndexer:
    def index_topic(self,topic_path): # Return dict of queries
        dic = dict()
    ...
    def find_relq_dic(self,file_path): # return dictionary that associate each query to its relevant documents
        dic = dict()
